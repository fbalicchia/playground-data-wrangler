# Declaimer this module is inspired from https://github.com/bitsondatadev/trino-getting-started/tree/main/hive
...
WITH (location='s3a://tiny/myschema');
```

```
CREATE SCHEMA delta.myschema WITH (location='s3a://tiny/myschema');
```
